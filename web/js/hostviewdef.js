...
function ibip_cell(val, item) {
   ...
   */
   ...
   function gerr_chstatus_cell(val, item) {
      let c = {NEW: "", MERGED: "#399539", ABANDONED: "#c73f3f"};
   ...
   var fldinfo_gerr_change = [
     ...
     {"name": "status",      "title": "Status",    type: "text", width: 13, itemTemplate: gerr_chstatus_cell},
   ...
   let fldinfo_gerr_proj =[
    ...
    {name: "description", title: "Description", type: "text", width: 25, itemTemplate: gerr_repodesc_cell},
