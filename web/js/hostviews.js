...
var tabloadacts = [
  ...
  */
  {name: "Gerrit - My Changes", tmpl: "simplegrid", "hdlr": simplegrid_url,  url: "/gerr/changes", gridid: "jsGrid_mych", fsetid: "gerr_change", path: "mychange", uisetup: null, dprep: null},
  ...
  {"name": "Artifactory MultiServer Repos", tmpl: null, hdlr: multigridview, url: "/afarepos/all", gridid: "jsGrid_afarepos_all", fsetid: "afa_repos",
    ...
    titletmpl: "<h2>{{name}}  (ID: {{entid}}, {{rowcnt}} Repos)</h2>\n", // (ID: {{id}}
    uisetup: null, 
  },
